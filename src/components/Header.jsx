        ...
        <nav>
          <ul className="flex gap-6">
            <li>
              <Link
                to={`/items`}
                className={`${path === "/items" && ('fill-primary text-primary')} flex cursor-pointer items-center gap-1`}
              >
                <svg
            ...
            <li>
              <Link
                to={`/essentials`}
                className={`${path === "/essentials" && ('fill-primary text-primary')} flex cursor-pointer items-center gap-1`}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="1em"
            ...
            <li>
              <Link
                to={`/stationary`}
                className={`${path === "/stationary" && ('fill-primary text-primary')} flex cursor-pointer items-center gap-1`}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="1em"
            ...
            <li>
              <Link
                to={`/book-cell`}
                className={`${path === "/book-cell" && ('fill-primary text-primary')} flex cursor-pointer items-center gap-1`}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="1em"
            ...
            <li>
              <Link
                to={`/tea-stall`}
                className={`${path === "/tea-stall" && ('fill-primary text-primary')} flex cursor-pointer items-center gap-1`}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="1em"
            ...
            <li>
              <Link to={`/search`} 
                className={`${path === "/search" && ('fill-primary text-primary')} flex cursor-pointer items-center mx-2`}
                >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="1em"
            ...
            <li>
              <Link
                to={`/contact-us`}
                className={`${path === "/contact-us" && ('fill-primary text-primary')} flex cursor-pointer items-center gap-1`}
              >
                Contact Us
              </Link>
            </li>
